...
grep -Fq 'value: "[\"https://workflows.platform.example.com/*\"]"' "${rendered}"
grep -Fq 'value: "[\"https://workflows.platform.example.com\"]"' "${rendered}"
grep -Fq 'https://dashboard.platform.example.com/*##https://workbench.platform.example.com/*##https://workflows.platform.example.com/*' "${rendered}"
grep -Fq '+ $additionalRedirects' "${rendered}"
grep -Fq '+ $additionalOrigins' "${rendered}"
grep -Fq '"tenant_did":"did:web:tenant.platform.example.com"' "${rendered}"
grep -Fq 'oidc-hardcoded-claim-mapper' "${rendered}"
